...
post_level_execution_config = {
    ...
    "data": {
        "dataset": "echo_2_kg_no_edit",  # possible values: ["echo_2", "echo_2_kg", "gab", "gab_kg", "waseem_2", "waseem_3", "davidson_2", "davidson_3"]
        'test_size': 0.2
    },
...
post_level_conf = {
    ...
    "echo_2_kg": {
        "data_path": "data/post_level/echo_posts_2_labels_kg.tsv",  # all_annotations_2_labels.tsv  echo_tweets_2_labels.tsv",
        "text_column": "text",
        "label_column": "label",
        "labels": [0, 1],
        "labels_interpretation": ["neutral-responsive", "hate speech"]
    ...
    "echo_2_kg2": {
        "data_path": "data/post_level/echo_posts_2_labels_kg2.tsv",  # all_annotations_2_labels.tsv  echo_tweets_2_labels.tsv",
        "text_column": "text",
        "label_column": "label",
        "labels": [0, 1],
        "labels_interpretation": ["neutral-responsive", "hate speech"]
    ...
    "echo_2_kg_no_edit": {
        "data_path": "data/post_level/echo_kg_sep.tsv",  # all_annotations_2_labels.tsv  echo_tweets_2_labels.tsv",
        "text_column": "text",
        "label_column": "label",
        "labels": [0, 1],
        "labels_interpretation": ["neutral-responsive", "hate speech"]
    ...
    "echo_2_kg2_no_edit": {
        "data_path": "data/post_level/echo_posts_2_labels_kg2_no_edit.tsv",  # all_annotations_2_labels.tsv  echo_tweets_2_labels.tsv",
        "text_column": "text",
        "label_column": "label",
        "labels": [0, 1],
        "labels_interpretation": ["neutral-responsive", "hate speech"]
    ...
    "gab_kg": {
        "data_path": "data/post_level/gab_posts_2_labels_kg.tsv",
        "text_column": "text",
        "label_column": "label",
        "labels": [0, 1],
        "labels_interpretation": ["Not-HS", "HS"]
    ...
    "gab_kg2": {
        "data_path": "data/post_level/gab_posts_2_labels_kg2.tsv",
        "text_column": "text",
        "label_column": "label",
        "labels": [0, 1],
        "labels_interpretation": ["Not-HS", "HS"]
    ...
    "gab_kg_no_edit": {
        "data_path": "data/post_level/gab_posts_2_labels_kg_no_edit.tsv",
        "text_column": "text",
        "label_column": "label",
        "labels": [0, 1],
        "labels_interpretation": ["Not-HS", "HS"]
    ...
    "gab_kg2_no_edit": {
        "data_path": "data/post_level/gab_posts_2_labels_kg2_no_edit.tsv",
        "text_column": "text",
        "label_column": "label",
        "labels": [0, 1],
        "labels_interpretation": ["Not-HS", "HS"]
